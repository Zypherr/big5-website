    ...
    <div class="site-wrapper site-layout--default">
        <header id="header" class="site-header site-header--bottom">
            <div class="header-logo header-logo--img">
                <a href="index.html">
                    <img src="assets/img/Website-logo-White-2-200x200.png"
                        srcset="assets/img/Website-logo-2-200x200.png" alt="Big5Esports" />
                </a>
            </div>
            ...
            <div class="site-content__inner">
                <div class="site-content__holder">
                    ...
                    <div class="page-content">
                        ...
                        <p>
                            If you have any questions, just send us and email and don’t forget to follow and like all
                            our social accounts to keep updated!
                        </p>
                        <div class="info-box">
                            <div class="info-box__label">General inquiries</div>
                            <div class="info-box__content">
                                <a href="mailto:#">info<span class="color-primary">@</span>Big5esports.co.za</a>
                            </div>
                        </div>
                        ...
                        <p>
                            We’re always looking for new talent to join our teams. If you wanna join us, just send us
                            and email and we’ll get back to you!
                        </p>
                        ...
                        <div class="card-body">
                            <form action="/assets/php/process.php" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <textarea name="msg" class="form-control" cols="30" rows="3"
                    ...
                    <!-- Google Map -->
                    <div class="gm-map gm-map--aside" data-map-style="necromancers"
